...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Moment.account'
        db.alter_column(u'core_moment', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Account'], null=True))

    def backwards(self, orm):

        # Changing field 'Moment.account'
        db.alter_column(u'core_moment', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Account']))
